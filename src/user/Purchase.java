    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField3.getText().isEmpty()) {
            ...
            if (!isProductExist(proId)) {
                ...
                JOptionPane.showMessageDialog(this, "Product already purchase", "Warning", 2);
            }
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    //Purchase btn
    //loi chua the lay email user
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        model = (DefaultTableModel) jTable2.getModel();
        if (model.getRowCount() > 0) {
            String[] value = new String[5];
            String email = UserDashboard.juserEmail.getText();
            ...
            JOptionPane.showMessageDialog(this, "Successfully purchase");
        } else {
...
//            jTable2.print(jTable2.PrintMode.FIT_WIDTH, header, footer);
