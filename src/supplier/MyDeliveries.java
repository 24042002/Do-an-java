...
public class MyDeliveries extends javax.swing.JFrame {
    ...
    private void init(){
        SuppliersName = supplierDao.getSupplierName(SupplierDashboard.jSupplierEmail.getText());
        myDeliveredTable();
    }
    private void myDeliveredTable() {
        purchaseDao.getDeliveredProduct(jTable1, "", SuppliersName);
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        jLabel11.setForeground(textPrimaryColor);
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        purchaseDao.getDeliveredProduct(jTable1, jTextField1.getText(), SuppliersName);
